...
const ASSET_LOGOS: Array<{ pattern: RegExp; src: string }> = [
  ...
  { pattern: /clear/i, src: assetPath("../assets/benefit-logos/clear logo.png") },
  { pattern: /uber one/i, src: assetPath("../assets/benefit-logos/uber one logo.png") },
  { pattern: /uber(?!\s*one)/i, src: assetPath("../assets/benefit-logos/uber logo.png") },
  { pattern: /saks/i, src: assetPath("../assets/benefit-logos/saks logo.png") },
  { pattern: /lululemon/i, src: assetPath("../assets/benefit-logos/lululemon logo.png") },
  { pattern: /walmart/i, src: assetPath("../assets/benefit-logos/walmart logo.png") },
  { pattern: /capital one travel/i, src: assetPath("../assets/benefit-logos/capital one travel.png") },
  { pattern: /global entry/i, src: assetPath("../assets/benefit-logos/global entry logo.png") },
  { pattern: /tsa pre.?check/i, src: assetPath("../assets/benefit-logos/tsa precheck logo.png") },
];
...
const BENEFIT_LOGOS: Array<{ pattern: RegExp; spec: BenefitLogoSpec }> = [
  ...
  { pattern: /uber(?!\s*one)/i, spec: { bg: "#000000", fg: "#ffffff", text: "Uber" } },
  { pattern: /uber one/i, spec: { bg: "#111827", fg: "#67e8f9", text: "Uber+" } },
  { pattern: /saks/i, spec: { bg: "#111111", fg: "#ffffff", text: "SAKS" } },
  { pattern: /dunkin/i, spec: { bg: "#f97316", fg: "#ec4899", text: "DUNKIN" } },
  { pattern: /lululemon/i, spec: { bg: "#dc2626", fg: "#ffffff", text: "LULU" } },
  { pattern: /walmart/i, spec: { bg: "#1d4ed8", fg: "#facc15", text: "WM" } },
  { pattern: /streaming/i, spec: { bg: "#7c3aed", fg: "#ffffff", text: "PLAY" } },
