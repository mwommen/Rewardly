...
const CARD_LOGOS: Record<string, string> = {
  ...
  "amex-everyday-preferred": logoPath("/card-logos/Amex EveryDay\u00ae Preferred Credit Card.png"),
  "amex-green": logoPath("/card-logos/Amex Express Green.png"),
  "amex-blue-business-plus": logoPath("/card-logos/Amex Blue Business Plus.png"),
  "chase-sapphire-preferred": logoPath("/card-logos/chase-sapphire-preferred.png"),
  "chase-freedom-unlimited": logoPath("/card-logos/chase-freedom-unlimited.png"),
  "chase-ink-business-unlimited": logoPath("/card-logos/Ink Business Unlimited Chase .png"),
  ...
  "chase-ink-business-cash": logoPath("/card-logos/Ink Business Cash\u00ae Credit Card.png"),
  ...
  "capital-one-venture-rewards": logoPath("/card-logos/Capital One Venture Rewards.png"),
  "boa-customized-cash-rewards": logoPath("/card-logos/Bank Of America Customized Cash Rewards.png"),
  "boa-unlimited-cash-rewards": logoPath("/card-logos/Bank of America Unlimited Cash Rewards.png"),
  "boa-travel-rewards": logoPath("/card-logos/Bank of America\u00ae Travel Rewards.png"),
  "usbank-cash-plus": logoPath("/card-logos/U.S. Bank Cash+\u00ae Visa Signature\u00ae Card.png"),
  "usbank-smartly": logoPath("/card-logos/U.S. Bank Smartly\u2122 Visa Signature\u00ae Card.png"),
  "usbank-shield": logoPath("/card-logos/U.S. Bank Shield\u2122 Visa\u00ae Card.png"),
  "usbank-altitude-go": logoPath("/card-logos/U.S. Bank Altitude\u00ae Go Visa Signature\u00ae Card.png"),
  "usbank-split": logoPath("/card-logos/Split\u2122 World Mastercard\u00ae.png"),
...
const NAME_FALLBACKS: Array<[RegExp, string]> = [
  ...
  [/amex.*everyday(?!.*preferred)|american express.*everyday(?!.*preferred)/i, "amex-everyday"],
